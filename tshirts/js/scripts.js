...
function updateOrderDetails() {
    ...
    var orderedTotal = calculateTotal();
    var unitUrl = "img/" + products[search_params.color][search_params.style].photo;
    ...
    $("#total-price").text(orderedTotal);
    $("#photo-product").attr("src", unitUrl);
